...
abstract class AppColorSchemes {
  // Material 3 defaults captured from the supplied Figma Color Modes
  // collection. Generated apps start from this explicit design-kit palette.
